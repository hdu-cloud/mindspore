...
set_target_properties(gtest PROPERTIES
    IMPORTED_LOCATION ${GTEST_PKG_DIR}/${CMAKE_INSTALL_LIBDIR}/libgtest.so
)

add_library(gtest_main SHARED IMPORTED)

set_target_properties(gtest_main PROPERTIES
    IMPORTED_LOCATION ${GTEST_PKG_DIR}/${CMAKE_INSTALL_LIBDIR}/libgtest_main.so
)
...
install(FILES ${GTEST_PKG_DIR}/${CMAKE_INSTALL_LIBDIR}/libgtest.so ${GTEST_PKG_DIR}/${CMAKE_INSTALL_LIBDIR}/libgtest_main.so OPTIONAL
